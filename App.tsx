...
const MASTER_ITINERARY = [
  ...
  {
    day: "8/16 Sun.", title: "布城 & 馬六甲古城巡禮", city: "馬六甲", hotel: "吉隆坡豪亞酒店式公寓", lat: 2.1896, lng: 102.2501,
    items: [
  ...
  {
    day: "8/17 Mon.", title: "吉隆坡城市漫遊", city: "吉隆坡", hotel: "吉隆坡豪亞酒店式公寓", lat: 3.1390, lng: 101.6869,
    items: [
  ...
  {
    day: "8/18 Tue.", title: "吉隆坡 → 檳城喬治市", city: "檳城", hotel: "檳城雙威喬治市酒店", lat: 5.4141, lng: 100.3288,
    items: [
  ...
  {
    day: "8/19 Wed.", title: "檳城自然探索", city: "檳城", hotel: "檳城雙威喬治市酒店", lat: 5.4141, lng: 100.3288,
    items: [
  ...
  {
    day: "8/20 Thu.", title: "檳城人文漫遊", city: "檳城", hotel: "檳城雙威喬治市酒店", lat: 5.4141, lng: 100.3288,
    items: [
  ...
  {
    day: "8/21 Fri.", title: "檳城海灘渡假", city: "檳城", hotel: "檳城香格里拉金沙酒店", lat: 5.4667, lng: 100.2452,
    items: [
  ...
  {
    day: "8/22 Sat.", title: "檳城 → 臺灣", city: "檳城", hotel: "溫暖的家", lat: 5.2971, lng: 100.2768,
    items: [
...
export default function App() {
  ...
  // 量測頁首高度，讓「Day 選擇列 + 當日資訊卡」可以精準吸附在頁首正下方
  ...
  return (
    <div className="max-w-md mx-auto min-h-screen pb-28 shadow-2xl relative" style={{ backgroundColor: THEME.bg }}>
      ...
      {/* Header */}
      <header ref={headerRef} className="px-4 py-5 text-white shadow-md sticky top-0 z-40" style={{ backgroundColor: THEME.primary }}>
      ...
      <main className="p-4 space-y-4">
        ...
        {activeTab === 'itinerary' && (
          <div className="space-y-3">
            <div className="sticky z-30 -mx-4 px-4 pb-3" style={{ top: headerHeight, backgroundColor: THEME.bg }}>
              <div className="flex overflow-x-auto space-x-2 pb-1 pt-3 scrollbar-none">
                {itinerary.map((d, idx) => (
                  <button
                    key={idx}
                  ...
                  >
                    <div>Day {idx + 1}</div>
                    <div className="opacity-75 text-[10px]">{d.day}</div>
                  </button>
                ))}
              </div>
        ...
        {activeTab === 'rate' && (
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-slate-900 to-slate-800 text-white p-4 rounded-2xl shadow-md border border-slate-700">
              <div className="flex justify-between items-center">
                <span className="text-sm font-bold">💱 馬幣 → 台幣 市場即時匯率</span>
                <button
